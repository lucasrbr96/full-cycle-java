...
public class GenreJpaEntity {
    ...
    public static GenreJpaEntity from(final Genre aGenre){
        ...
        aGenre.getCategories().forEach(anEntity::addCategories);
        return anEntity;
    }
    ...
    private void addCategories(final CategoryID anId){
        this.categories.add(GenreCategoryJpaEntity.from(this, anId));
    }

    private void removeCategories(final CategoryID anId){
