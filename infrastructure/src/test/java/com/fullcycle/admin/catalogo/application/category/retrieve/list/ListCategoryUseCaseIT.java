...
class ListCategoryUseCaseIT {
    ...
    void mockUp(){
        final var categories = Stream.of(
                ...
                Category.newCategory("Netflix", "Título de autoria da netflix", true),
                Category.newCategory("Amazon Originals", "Título de autoria da Amazon Prime", true),
    ...
    void givenAValidTerm_whenTermDoesntMatchesPrePersisted_shouldReturnEmptyPage(){
        ...
        final var expectedTerms = "jsijsisjis sjsji";
    ...
    void givenAValidPage_whenCallsListsCategories_shouldReturnCategoriesPaginated(
            final int expectedPage,
            final int expectedPerPage,
            final int expectedItemsCount,
            final long expectedTotal,
