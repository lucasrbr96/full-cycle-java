...
public class GenreE2ETest implements MockDsl {
    ...
    @Test
    public void asACatalogAdminIShouldBeAbleToCreateANewGenreWithGenres() throws Exception {
        Assertions.assertTrue(MY_SQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, genreRepository.count());
    ...
    @Test
    public void asCatalogAdminIShouldBeAbleToATreatedErrorByGettingANotFoundGenre() throws Exception {
        Assertions.assertTrue(MY_SQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, genreRepository.count());
    ...
    @Test
    public void asCatalogAdminIShouldBeAbleToUpdateAGenreByItsIdentifier() throws Exception {
        Assertions.assertTrue(MY_SQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, genreRepository.count());
    ...
    @Test
    public void asCatalogAdminIShouldBeAbleToInactiveAGenreByItsIdentifier() throws Exception {
        Assertions.assertTrue(MY_SQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, genreRepository.count());
        ...
        final var actualId = givenAGenre("acao", true, expectedCategories);
    ...
    @Test
    public void asCatalogAdminIShouldBeAbleToActiveAGenreByItsIdentifier() throws Exception {
        Assertions.assertTrue(MY_SQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, genreRepository.count());
        ...
        final var actualId = givenAGenre("acao", false, expectedCategories);
