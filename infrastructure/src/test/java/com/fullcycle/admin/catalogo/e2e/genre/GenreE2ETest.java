...
public class GenreE2ETest implements MockDsl {
    ...
    @Test
    public void asCatalogAdminIShouldBeAbleToDeleteAGenreByItsIdentifier() throws Exception {
        Assertions.assertTrue(MY_SQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, genreRepository.count());
    ...
    @Test
    public void asCatalogAdminIShouldNotSeeAErrorByDeletingNotExistentGenre() throws Exception {
        Assertions.assertTrue(MY_SQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, genreRepository.count());
