...
public interface MockDsl {
    ...
    default CategoryResponse retrieve(final CategoryID anId) throws Exception {
    ...
    default ResultActions listGenres(final int page, final int perPage, final String search, final String sort, final String directions) throws Exception {
